...
export default function Dashboard() {
  ...
  // Stats calculations
  const todayStats = (stats as any)?.today || { newLeads: 0, responses: 0, callsScheduled: 0, delivered: 0 };
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <a href="/" className="flex items-center space-x-2 hover:opacity-80 transition-opacity">
              ...
              <span className="font-bold text-xl text-gray-900">Pleasant Cove Design</span>
            </a>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{(stats as any)?.totalLeads || 0}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{(stats as any)?.activeCampaigns || 0}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{(stats as any)?.conversionRate || "0.0"}%</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">${(stats as any)?.monthlyRevenue?.toLocaleString() || "0"}</p>
                  </div>
                  <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                    <span className="text-green-600 text-lg">💰</span>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="p-6 space-y-4">
                {(campaigns as any)?.filter((c: any) => c.status === 'active').map((campaign: any) => (
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-gray-900">{(stats as any)?.today?.newLeads || 0}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">SMS responses</span>
                    <span className="font-medium text-gray-900">{(stats as any)?.today?.responses || 0}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Calls scheduled</span>
                    <span className="font-medium text-gray-900">{(stats as any)?.today?.callsScheduled || 0}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Websites delivered</span>
                    <span className="font-medium text-gray-900">{(stats as any)?.today?.delivered || 0}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent className="p-6">
              <div className="relative h-64 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-4 overflow-hidden">
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  <div>
                    <h4 className="text-2xl font-bold text-gray-900">${(stats as any)?.monthlyRevenue?.toLocaleString() || "0"}</h4>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-900">${(stats as any)?.avgDealSize || 450}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Monthly Recurring</p>
                  <p className="text-xl font-bold text-gray-900">${(stats as any)?.monthlyRecurring?.toLocaleString() || "0"}</p>
                </div>
              </div>
            </CardContent>
          </Card>
